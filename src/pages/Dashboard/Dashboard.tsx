...
export const Dashboard: FC = () => {
  return (
    <div className="dashboard">
      ...
      <div className="dashboard__marketting">
        <div className="dashboard__marketting--stats">
          ...
          <div className="dashboard__marketting--stats-bullets">
            <div className="dashboard__marketting--stats-bullets-1">
              <div />
              <p>Acquisition</p>
            </div>

            <div className="dashboard__marketting--stats-bullets-2">
              <div />
              <p>Purchase</p>
            </div>

            <div className="dashboard__marketting--stats-bullets-3">
              <div />
              <p>Retention</p>
            </div>
          </div>
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="dashboard__marketting--stats-chart"
          >
            <path
        ...
        <div className="dashboard__marketting--cards">
          {cardData2.map((card) => {
            return (
              <Card
                key={card.icon}
      ...
      <div className="dashboard__summary">
        <div className="dashboard__summary--top">
          <div className="dashboard__summary--top-left">
            <p className="dashboard__heading">Summary</p>

            <div className="dashboard__summary--top-left-sales">
              <p>Sales</p>
              <svg
                width="12"
                height="8"
          ...
          <div className="dashboard__summary--top-dropdown">
            <p>Last 7 days</p>
